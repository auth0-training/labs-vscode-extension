...
[![Visual Studio Marketplace Installs](https://vsmarketplacebadges.dev/installs/auth0.vscode-labs.svg?color=%23ff00ff&logo=Auth0)](https://marketplace.visualstudio.com/items?itemName=auth0.vscode-labs)[![MIT](https://img.shields.io/badge/license-MIT-orange.svg?color=%2300ffff)](https://opensource.org/licenses/MIT)
